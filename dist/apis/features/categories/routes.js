...
routes.post('/', (0, validate_1.default)(inputs.addCategory), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { name, description } = req.body;
        const response = yield controllers.addCategory(name, description);
