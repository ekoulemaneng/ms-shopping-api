...
routes.post('/', (0, validate_1.default)(inputs.addBrand), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { name, description } = req.body;
        const response = yield controllers.addBrand(name, description);
